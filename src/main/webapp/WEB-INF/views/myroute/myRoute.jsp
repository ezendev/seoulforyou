...
<div class="container text-center clearfix">
  	<div class="row row-cols-4 g-10 p-5">
    ...
    <div class="col-lg-2 col-md-6">
		<input class="btn btn-outline-dark" type="button" value="초기화" onclick="location.href='myRoute.do'">
...
<div class="container text-center">
	...
	<div class="col-lg-2">
		...
		<div class="pt-2">
			<button class="btn btn-outline-dark border-opacity-25" style="height:60px"type="submit" id="favoritebtn" name="favoritebtn" formaction="addList.do?tour_no=${fa.tour_no}">	    
	...
	<div class="row justify-content">
		<select class="form-select" style="width:80px;"name="searchType" id="searchType" onchange="searchFilter()">
			...
			<input type="text" class="ms-2" name="keyword" style="width:130px">
			<button class="btn btn-outline-success btn-sm ms-2" style="width:50px" type="submit" formaction="tourFind.do">GO!</button>
	</div>
	<!-- 검색결과 -->
	...
	<c:if test="${not empty findList}">
		...
		<div class="pt-2">
			<button class="btn btn-outline-dark" style="height:80px"type="submit" id="tourbtn" name="tourbtn" formaction="addList.do?tour_no=${fdto.tour_no}">	    
	...
	<div class="col-lg-3">
	<label class="ps-3">일정 만들기</label>
	<button class="btn btn-outline-secondary" type="button" onclick="setBounds()">루트</button> 
	<div class="container" style="overflow:scroll; height:600px">
   		...
   		<br>
   		<div class="border border-dark rounded border-opacity-25" style="width: 230px; height:120px;">
			<div class="row justify-content">
					<div class="col-md-3 ps-3">
				      <img src="resources/img/1.jpg" class="img-fluid-center rounded-start pt-2" style="width:50px; height:50px">
				    </div>
				    <div class="col-md-6 p-3">
				        <p class="card-text text-truncate" id="spot_info">${rdto.getTour_name()}</p>
				   </div>
				   <div class="col-md-3">
					<button class="btn" type="submit" formaction ="delList.do?tour_no=${rdto.getTour_no()}">
			...
			<div class="row justify-content p-3">
				 <small class="text-muted text-truncate" id="addr">${rdto.getTour_addr()}</small>			
			</div> 
		</div>
   		</c:forEach>
   		</c:if>
