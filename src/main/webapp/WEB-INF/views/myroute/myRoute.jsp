	        ...
	        <div style="overflow:auto; height:300px;">
		        ...
		        <c:if test="${not empty favorite}">
			        <c:forEach var="fa" items="${favorite}">
				          ...
				          id="favoritebtn" name="favoritebtn" formaction="addList.do?tour_no=${fa.tour_no}">	    
      ...
      <br>
			...
			<c:if test="${not empty findList}">
				<c:forEach var="fdto" items="${findList}">	
					...
					<button class="btn btn-outline-dark" style=" height:80px; margin-bottom:10px"type="submit" id="tourbtn" name="tourbtn" formaction="addList.do?tour_no=${fdto.tour_no}">	    
			   		...
			   		<div class="border border-dark rounded border-opacity-25" style="width: 500px; height:100px;margin-left:50px" >
						<div class="col" align="center">
							...
							<div class="col-2 d-flex justify-content-end align-items-center">
								<button class="btn" type="submit"   formaction ="delList.do?tour_no=${rdto.getTour_no()}" style="margin-top:-10px">
