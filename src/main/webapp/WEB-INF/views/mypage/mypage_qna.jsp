...
<body>
   <div class="container">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a class="nav-link js-scroll-trigger" href="#mypage_qna">
          <svg class="bi pe-none me-2" width="16" height="16"></svg>
          문의 내역
        </a>
      </li>
  ...
  <div class="wrapper col-md-9">
    ...
    <div class="content-wrapper">
		...
		<tr>
			<td colspan="7">등록된 문의내역이 없습니다.</td>
		</tr>
	</c:if>
	<c:forEach var="dto" items="${listMember}">
		<tr> 
			...
			<td>${dto.qna_datetime}</td>
	</c:forEach> --%>
        <section class="content container-fluid">
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">문의 내역 목록</h3>
                    </div>
                    <div class="box-body">
            ...
            <option value="qna_subject" <c:out value="${cri.searchType eq 'qna_subject' ? 'selected' : ''}"/>>제목</option>
        </select>
