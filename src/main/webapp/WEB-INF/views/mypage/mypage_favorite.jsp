...
<body>
   <div class="container">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a class="nav-link js-scroll-trigger" href="#mypage_favorite">
          <svg class="bi pe-none me-2" width="16" height="16"></svg>
          나의 즐겨찾기
        </a>
      </li>
  ...
  <div class="wrapper col-md-9">
	...
	--%>
        <section class="content container-fluid">
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">나의 즐겨찾기 목록</h3>
                    </div>
                    <div class="box-body">
            ...
            <option value="favorite_subject" <c:out value="${cri.searchType eq 'favorite_subject' ? 'selected' : ''}"/>>제목</option>
            <option value="favorite_category" <c:out value="${cri.searchType eq 'favorite_category' ? 'selected' : ''}"/>>카테고리</option>
